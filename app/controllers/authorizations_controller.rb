class AuthorizationsController < ApplicationController
  ...
  def create
    ...
    # current_user = User.find_by_email(omniauth.uid+"@gmail.com")
    @auth = Authorization.find_from_hash(omniauth) #if current_user.blank?
    if current_user
      ...
      @new_auth = Authorization.create_from_hash(omniauth, nil) #Create a new user
      ...
      redirect_to edit_user_path(@new_auth.user)
    end
  end
